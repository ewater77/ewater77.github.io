...
categories:
    - 資訊安全
cover: /images/Anti-Social-Engineer/social_engineer.png
---

![社交工程示意圖](/images/Anti-Social-Engineer/social_engineer.png)

## 當詐騙集團比 Netflix 還會拍劇

最近新聞看多了，發現詐騙集團的演技已經超越演藝圈了。他們會深情款款地叫你「親愛的」，會聲淚俱下地說包裹出了問題，還會激動萬分地說有投資機會讓你日賺 5%。

奧斯卡真的欠他們一座小金人。

你媽轉傳的那些「緊急通知」貼圖，搞不好就是詐騙集團的情書。今天我們要用 5 分鐘教你提升防詐技能，讓你不再當薯條！
...
3. **人性弱點**：我們都想要快速致富、怕錯失機會、怕被罵

## 心態篇：被騙不是笨，而是人性

連金融專家、律師、醫生都有人差點中招。會上當不代表你笨，只是詐騙集團真的太會抓人性弱點。

重點是：**被騙了要勇敢報案**！不要覺得丟臉，你的報案可能救了下一個人。

## 辨別網站真偽：技術篇

雖然大部分詐騙都在通訊軟體，但網站詐騙也要小心！身為資安從業者，我必須告訴你：90% 的網路詐騙都是從假網站開始的。
...
- **通訊協定**：`https://`（有 SSL 憑證，但不代表不是詐騙）
- **網域**：`www.walter.com.tw`（最重要！這是判斷真偽的關鍵）
- **路徑**：`images`
...
2. **子網域欺騙**
   ...
   - 看起來有 paypal.com，但真正的網域是 `security-check.net`
...
4. **假冒官方子網域**
   ...
   - 看起來很官方，但網域主體是 `verification-center.com`
...
1. 詐騙（真正網域是 security-update.net）
2. 正版
3. 詐騙（真正網域是 checkout.com）
4. 正版（microsoft 在台灣的官方網域）
...
4. **Google 監控暗網中的資料侵害事件**：讓 Google 幫你監看帳號密碼是否被外洩在暗網 <https://myactivity.google.com/dark-web-report/dashboard>
